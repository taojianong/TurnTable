...
:: Android packaging
set AND_CERT_NAME="TurnTable"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TurnTable.p12
...
set IOS_PROVISION=cert\TurnTable.mobileprovision
...
set APP_ID=air.TurnTable

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TurnTable
